...
CARDCSS = ('.card{display:flex;flex-direction:column;gap:0;padding:0;overflow:hidden}'
...
if '.thumb{' in new:
    new = re.sub(r'\.card\{display:flex;flex-direction:column;gap:0.*?padding:14px 16px\}', CARDCSS, new, flags=re.S)
else:
